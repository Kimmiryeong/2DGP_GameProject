...
class IdleState:
    ...
    def draw(Mario):
        ...
        if Mario.x > 450:
            ...
            if Mario.left == 1:
                if Mario.obj_Mush.collision == True:
                    Mario.image_big_left.draw(Mario.x, Mario.y+ 2)
                else:
                    Mario.image_left.draw(Mario.x, Mario.y)
            
            else:
                if Mario.obj_Mush.collision == True:
                    Mario.big_image.draw(Mario.x, Mario.y+ 2)
                else:
                    Mario.image.draw(Mario.x, Mario.y)
...
class RunState:
    ...
    def draw(Mario):
        ...
        if Mario.x > 450:
            ...
            if Mario.obj_Mush.collision == True:
                if Mario.left == 1:
                    Mario.image_big_leftrun.draw(Mario.x, Mario.y+ 2)
                else:
                    Mario.image_big_run.draw(Mario.x, Mario.y + 2)
            else:
...
class Mario:
    ...
    def __init__(self):
        ...
        self.image_big_run = load_image('Lrun1.gif')
        self.image_left = load_image('left.gif')
        self.image_big_left = load_image('Bleft.gif')
        self.image_leftrun = load_image('left_run.gif')
        self.image_big_leftrun = load_image('Bleft_run.gif')
        self.dir = 1
        self.velocity = 0
        self.frame = 0
        self.timer = 0
